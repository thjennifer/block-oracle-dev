- dashboard: qa_order_counts_and_percents
  ...
  #   y_axes: []
  #   listen:
  #     category_description: sales_orders__lines.category_description
  ...
  - title: SalesOrders using Order Category Code Filter
    name: SalesOrders_counts_by_order_category_code
    explore: sales_orders
    type: looker_grid
    fields: [sales_orders.order_count, sales_orders.no_holds_order_count, sales_orders.cancelled_order_count,
      sales_orders.has_return_sales_order_count, sales_orders.blocked_order_count,
      sales_orders.open_order_count, sales_orders.fulfilled_order_count, sales_orders.fulfilled_by_request_date_order_count,
      sales_orders.has_backorder_order_count, sales_orders.fulfilled_by_promise_date_order_count,
      sales_orders.fillable_order_count, sales_orders.non_cancelled_order_count]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
  ...
  #     category_description: sales_orders_daily_agg__lines.category_description
  ...
  - title: Agg Counts using Order Category Code
    name: Agg Counts Order Category Code
    explore: sales_orders_daily_agg
    type: looker_grid
    fields: [sales_orders_daily_agg.order_count, sales_orders_daily_agg.no_holds_order_count,
      sales_orders_daily_agg.cancelled_order_count, sales_orders_daily_agg.has_return_sales_order_count,
      sales_orders_daily_agg.blocked_order_count, sales_orders_daily_agg.open_order_count,
      sales_orders_daily_agg.fulfilled_order_count, sales_orders_daily_agg.fulfilled_by_request_date_order_count,
      sales_orders_daily_agg.has_backorder_order_count, sales_orders_daily_agg.fulfilled_by_promise_date_order_count,
      sales_orders_daily_agg.fillable_order_count, sales_orders_daily_agg.non_cancelled_order_count]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
  ...
  - title: SalesOrders %s
    ...
    explore: sales_orders
    type: looker_grid
    fields: [sales_orders.has_backorder_order_percent, sales_orders.cancelled_order_percent,
      sales_orders.has_return_sales_order_percent, sales_orders.fulfilled_order_percent,
      sales_orders.fulfilled_by_request_date_order_percent, sales_orders.no_holds_order_percent]
    filters:
  ...
  - title: Agg %s
    ...
    explore: sales_orders_daily_agg
    type: looker_grid
    fields: [sales_orders_daily_agg.has_backorder_order_percent, sales_orders_daily_agg.cancelled_order_percent,
      sales_orders_daily_agg.has_return_sales_order_percent, sales_orders_daily_agg.fulfilled_order_percent,
      sales_orders_daily_agg.fulfilled_by_request_date_order_percent, sales_orders_daily_agg.no_holds_order_percent]
    filters:
