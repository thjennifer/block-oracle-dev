- dashboard: otc_accounts_receivable_using_sales_payments_test
  ...
  - name: customers_with_highest_receivables
    ...
    fields: [sales_payments.bill_to_customer_number, sales_payments.bill_to_customer_name,
      sales_payments.total_receivables_target_currency, sales_payments.cumulative_total_receivables,
      sales_payments.percent_of_total_receivables]
    hidden_fields: [sales_payments.bill_to_customer_number, sales_payments.cumulative_total_receivables,
    sales_payments.percent_of_total_receivables]
    filters:
      sales_payments.is_payment_transaction: 'No'
    sorts: [sales_payments.percent_of_total_receivables desc]
    series_types:
      cumulative_percent_of_total_receivables: line
    series_colors: #2596be #74A09F
      sales_payments.total_receivables_target_currency: "#2596be"
    ...
    - category: table_calculation
      expression: "(${sales_payments.cumulative_total_receivables} / sum(${sales_payments.total_receivables_target_currency}))"
    ...
    y_axes: [{label: '', orientation: top, series: [{axisId: sales_payments.total_receivables_target_currency,
            id: sales_payments.total_receivables_target_currency, name: Total Receivables
    ...
    note_state: collapsed
    note_display: hover
    note_text: Customers ranked in descending order by Total Receivables. Black line overlaying totals reflects a customer's Cumulative Percent of Total Receivables. Limited to
  ...
  - name: customer_receivables_by_age
    ...
    note_state: collapsed
    note_display: hover
    note_text: 'Customers ranked in descending order by Total Past Due Receivables by
      Age. Number and size of age ranges are defined by dashboard parameters ''Aging
      Bucket: # of Days in Range'' and ''Aging Bucket: # of Ranges''. Limited to 10
