...
view: +sales_invoices__lines__item_descriptions {
  ...
  dimension: key {
    type: string
    primary_key: yes
    sql: CONCAT(${sales_invoices.invoice_id},${sales_invoices__lines.line_id},${sales_invoices__lines.inventory_item_id},${sales_invoices__lines.item_part_number},${language_code}) ;;
  }
