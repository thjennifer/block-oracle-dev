...
view: sales_invoices {
  sql_table_name: `zhangfrank2.REPORTING_OracleEBS.SalesInvoices` ;;
...
view: sales_invoices__lines {
  ...
  dimension: gross_unit_selling_price {
    type: number
    description: "Actual price chaged to customer post-tax"
    sql: GROSS_UNIT_SELLING_PRICE ;;
  }
  dimension: inventory_item_id {
    type: number
    description: "Foreign key identifing the item"
  ...
  dimension: tax_amount {
    type: number
    description: "Tax amount accociated with the transaction line"
    sql: TAX_AMOUNT ;;
  }
  ...
  dimension: unit_selling_price {
    type: number
    description: "Actual price chaged to customer pre-tax"
